###########This is the data loader script########################
#                                                               #
#                                                               # 
# The data-loader cifar10, cifar100, SVHN, MNIST and STL10      #
# The data is split into training and test dataset randomly     #
# maintaining a even split among all the classes of the dataset #
# Using this script strong and weak augmentations are applied   # 
# to the images those are loaded into the system randomly using #
# rand-augment                                                  #
# Random Crop and Horizontal flip are applied on the labeled    #
# dataset                                                       #
#################################################################
# Variable Description :
#   dataset {cifar10,cifar100,svhn, mnist and stl10}_mean has dataset specific mean
#   dataset {cifar10,cifar100,svhn, mnist and stl10}_std has dataset specific std.dev
#   dataset default_mean 
#   dataset default_std dev
#   

# Function Description : 
#   get_{cifar10, cifar100, SVHN, STL10, MNIST } loads the dataset
#   x_u_split :splits the data between training data and test data
#   Further the training data is split into the labeled and unlabeled
#   dataset based on the user input
#   
